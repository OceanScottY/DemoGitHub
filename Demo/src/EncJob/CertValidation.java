...
public class CertValidation {
     ...
     *
     * REM # create keystore file keytool -genkey -dname "CN=Test Bank, OU=Test,
     * O=Test, L=BeiJing, ST=BeiJing, C=CN" -alias testAlias -keyalg RSA
     * -keysize 2048 -keystore TestPrivate.jks -keypass 12345678 -storepass
     * 12345678 -validity 365
     *
     * REM # export cert file keytool -export -alias testAlias -file
     * TestPublic.cer -keystore TestPrivate.jks -storepass 12345678
     *
     *
     **/
     ...
     * @return
     */
    public static byte[] sign(byte[] srcByte, String keystorePath, String keystorePwd, String keystoreType,
                              String algorithm, String alias) {
        if (srcByte == null) {
     ...
     * @return
     */
    public static String sign(String srcData, String keystorePath, String keystorePwd, String keystoreType,
                              String algorithm, String alias) {
        ...
        byte[] rsByte = sign(srcByte, keystorePath, keystorePwd, keystoreType, algorithm, alias);
    ...
    private static String readString2() {
        ...
        File file = new File("C:/Program Files/Java/jre1.8.0_73/bin/myCASigned_child.cer");
    ...
    public static void main(String[] args) {
        String srcData = "I'm zzj!\n"+"S+PWOl336DzS+ytXXOgw0Udl4tBefUZv1oNEC4S572PRpiJl1205CAt0Iu8KptSA5ZRyudTVv3ks6l6vED/+xGwnJUkVXIR9sDYHjXEeYuCgVmM4CSkUzUSWD5RXnQG8ueK0yYwSbuLWSIpPmn+J9OiqrKxL8PJ5fjO07thvZDM=";
        // String srcData =
        // readString2();//+"JvwClvYgr5+OX9lQ7rzX2gf8zGvd9ifKtuBeNInuk8m9mP0GvzdrHKIXZOqncWOmEqpGzcXXwJzZ7pVzm2Ft/zNcM37ueuDT6PjU2fgIkgZaFe1xK9bOB9AbkqjeFkPym5XvBQt6cfDGxYNoEhjiT87w9mdENAqJADFNyFyvPgI=";
        // String
        // rsData="JvwClvYgr5+OX9lQ7rzX2gf8zGvd9ifKtuBeNInuk8m9mP0GvzdrHKIXZOqncWOmEqpGzcXXwJzZ7pVzm2Ft/zNcM37ueuDT6PjU2fgIkgZaFe1xK9bOB9AbkqjeFkPym5XvBQt6cfDGxYNoEhjiT87w9mdENAqJADFNyFyvPgI=";
        // 签名验签测试
        String rsData = sign(srcData, "E:\\Learning\\Java\\jre1.8.0_131\\bin\\yhyCALib", "123456", null, null,
                "yhyCASigned_dataowner");
//		boolean result = verify(srcData, rsData, "C:/Program Files/Java/jre1.8.0_73/bin/myCASigned_child.cer", null);
//
//		System.out.println(result);

        // 加密解密测试
        X509Certificate x509Certificate = getX509Certificate(
                "E:\\Learning\\Java\\jre1.8.0_131\\bin\\myCASigned_child.cer");
        ...
        KeyStore keyStore = getKeyStore("E:\\Learning\\Java\\jre1.8.0_131\\bin\\yhyCALib", "123456", null);
        PrivateKey privateKey = getPrivateKey(keyStore,
                "123456","myCASigned_child" );
        ...
        byte[] a = encrypt(srcData.getBytes(), publicKey);
        byte[] b=decrypt(a, privateKey);
